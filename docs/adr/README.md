...
| [0016](./0016-channel-goal-output-contract.md) | チャンネル goal（出力契約）の導入 | Superseded by ADR-0023 |
...
| [0023](./0023-community-artifact-config.md) | Community の成果物設定（artifactConfig）導入 | Accepted |
